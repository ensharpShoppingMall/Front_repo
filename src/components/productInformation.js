      ...
      <div className="information-container">
        <div className="product-information">
          <div className="product-detail">
            ...
            <br />
            <br />
            빈티지 클래식 무드의 타원형 쉐입 선글라스. 외경과 내경의 쉐입이 다른
            프론트 디테일을 더해 클래식한 디자인에 유니크하고 빈티지한 무드를
            더한 아이웨어입니다. 섬세한 디자인적 가치를 추구하는 아이웨어 브랜드
            OROR 와 만나 AMOMENTO의 23SS 시즌 컨셉을 볼륨감 있는 실루엣과 포인트
            컬러로 담아낸 완성도 높은 아이템입니다. 위아래로 둥근 곡선을 이루는
            템플 쉐입으로 디자인하여 아이템의 전체적인 라운드 실루엣의 통일감을
            더했습니다. 99.9% UV 차단이 되는 기능성 렌즈를 사용하여 자외선이
            강한 여름철에 활용하기 좋은 악세사리입니다.
            <br />
            <br />
            유니섹스
            <br />
            ...
            <br />
            <br />
            *고온에 장시간 노출 시 프레임 변형이 생길 수 있으니 이 점 유의하시길
            바랍니다.
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
              ...
              >
                <div className="accordion-body">사이즈 기입</div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header">
            ...
            <div class="accordion-item">
              ...
              >
                <div class="accordion-body">
                  " SHIPPING"
                  <br />- 아모멘토는 CJ대한통운과 배송대행 계약이 체결되어
                  있습니다.
                  <br />- 배송비
                  <br />
                </div>
...
function SizeButton() {
  const [isButtonClicked, setIsButtonClicked] = useRecoilState(false);
